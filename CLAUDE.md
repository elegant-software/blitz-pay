...
- Kotlin 2.3.20 on Java 25 + Spring Boot 4.0.4, Spring WebFlux, Spring Modulith, Spring AI (BOM already imported), Ollama via `spring-ai-starter-ollama` (new), `spring-ai-openai` (existing — for Whisper) (012-voice-ai-product-rag)
- PostgreSQL 16 via JPA + Liquibase — no new tables for this feature (012-voice-ai-product-rag)
